...
-- Column comments
COMMENT ON COLUMN vulnerability_scans.idempotency_key IS 'Unique identifier for each scan request (no longer used for deduplication - multiple scans allowed)';
